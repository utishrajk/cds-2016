...
public class CountryCodeDataOnDemand {
	...
	public void setCodeSystemVersion(CountryCode obj, int index) {
	...
	public CountryCode getSpecificCountryCode(int index) {
        ...
        Long id = obj.getId();
        return countryCodeService.findCountryCode(id);
    }
	...
	public void init() {
        int from = 0;
        int to = 10;
        data = countryCodeService.findCountryCodeEntries(from, to);
        if (data == null) {
