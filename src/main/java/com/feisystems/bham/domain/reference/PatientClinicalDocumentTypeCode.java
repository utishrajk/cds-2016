...
@Entity
public class PatientClinicalDocumentTypeCode extends AbstractCodedConcept implements Serializable {
...
//        if (!(obj instanceof PatientClinicalDocumentTypeCode)) {
//            return false;
//        }
//        if (this == obj) {
//            return true;
//        }
//        PatientClinicalDocumentTypeCode rhs = (PatientClinicalDocumentTypeCode) obj;
