...
@Entity
public class ResultInterpretationCode extends AbstractCodedConcept implements Serializable {
...
//        if (!(obj instanceof ResultInterpretationCode)) {
//            return false;
//        }
//        if (this == obj) {
//            return true;
//        }
//        ResultInterpretationCode rhs = (ResultInterpretationCode) obj;
