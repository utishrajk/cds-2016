...
@Entity
public class ProviderTaxonomyCode extends AbstractCodedConcept implements Serializable {
...
//        if (!(obj instanceof ProviderTaxonomyCode)) {
//            return false;
//        }
//        if (this == obj) {
//            return true;
//        }
//        ProviderTaxonomyCode rhs = (ProviderTaxonomyCode) obj;
