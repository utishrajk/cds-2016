...
@Controller
@RequestMapping("/socialhistorytypecodes")
public class SocialHistoryTypeCodeController {
	...
	public List<LookupDto> listJson() {
        ...
        List<LookupDto> result = socialHistoryTypeCodeService.findAllSocialHistoryTypeCodes();
        return result;
	}
