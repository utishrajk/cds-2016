...
@Controller
@RequestMapping("/providertaxonomycodes")
public class ProviderTaxonomyCodeController {
    ...
    public List<LookupDto> listJson() {
        ...
        List<LookupDto> result = providerTaxonomyCodeService.findAllProviderTaxonomyCodes();
        return result;
    }
