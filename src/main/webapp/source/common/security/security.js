...
.factory('AuthenticationSharedService', ['$rootScope', '$http', '$cookieStore', 'authService', 'Session', 'Account','$location', 
    function ($rootScope, $http, $cookieStore, authService, Session, Account, $location) {
        return {
